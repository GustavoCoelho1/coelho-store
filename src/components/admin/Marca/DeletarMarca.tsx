...
const DeletarMarcaForm: React.FC<Props> = ({ setUpdate, setVisible }) => {
    ...
    const onSubmit = handleSubmit(async (data: iFormProps) => {
        if (data.codigo != '') {
            ...
            const marca = marcaData?.deleteMarca;
            ...
            setFormStatus('error');
            setError('Digite o código da marca!');
...
export default DeletarMarcaForm;
